...
insert into pedido (id, id_cliente, data_pedido, total, status) values (1, 1, sysdate(), 100.0, 'AGUARDANDO');

insert into item_pedido (id, id_pedido, id_produto, preco_produto, quantidade) values (1, 1, 1, 5.0, 2);
